...
import com.example.imagecropdrawandtexteditor.editimage.model.RatioItem;
import com.example.imagecropdrawandtexteditor.editimage.utils.Matrix3;
...
public class CropFragment extends BaseEditFragment {
	...
	private final class CropImageTask extends AsyncTask<Bitmap, Void, Bitmap> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			dialog = BaseActivity.getLoadingDialog(getActivity(),"Saving",
					false);
			dialog.show();
		}
